...
source: https://github.com/scopecraft/command/blob/9325ea949ac6369ec773a2e68a2a733bc52df9d9/.claude/commands/create-command.md
author: Adam Bloomston (@adam-bloomston) made modifications to original source
---
...
<context>
CRITICAL: Read the command creation guide first: !`echo ~/.claude/commands/**/zzz-reference-claude-commands-guide.md`
